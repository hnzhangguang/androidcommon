...
public class TelephoneUtil {
    ...
    public static TeleInfo getMtkTeleInfo(Context context) {
        ...
        try {
            ...
            TelephonyManager tm = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
            Method getSubscriberIdGemini = TelephonyManager.class.getDeclaredMethod(
            ...
            Method getDeviceIdGemini = TelephonyManager.class.getDeclaredMethod("getDeviceIdGemini",
                    int.class);
            ...
            Method getPhoneTypeGemini = TelephonyManager.class.getDeclaredMethod("getPhoneTypeGemini",
                    int.class);
    ...
    public static TeleInfo getSpreadtrumTeleInfo(Context context) {
        ...
        try {
            ...
            String spreadTmService = (String) getServiceName.invoke(phoneFactory,
