...
public class NotificationService extends NotificationListenerService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        return notificationListener == null ? START_STICKY :
                notificationListener.onServiceStartCommand(this, intent, flags, startId);
    }
    ...
    public void printCurrentNotifications() {
        ...
        for (StatusBarNotification n : ns) {
            Log.i(TAG,
                    String.format("%20s", n.getPackageName()) + ": " + n.getNotification().tickerText);
        }
    }
    ...
    public static abstract class NotificationListener {
        ...
        public abstract int onServiceStartCommand(NotificationService service, Intent intent,
