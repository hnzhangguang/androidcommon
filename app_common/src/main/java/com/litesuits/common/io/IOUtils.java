...
public class IOUtils {
     ...
     * toBufferedReader for the given
     * reader.
     *
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.litesuits.common.io.stream.ByteArrayOutputStream output =
                new com.litesuits.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * @return the requested byte array
     * @throws IOException              if an I/O error occurs or <code>InputStream</code> size differ
     *                                  from parameter size
     * @throws IllegalArgumentException if size is less than zero or size is greater than Integer
     *                                  .MAX_VALUE
