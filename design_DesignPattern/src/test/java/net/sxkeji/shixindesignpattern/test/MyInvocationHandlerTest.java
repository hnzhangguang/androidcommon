...
import net.designpattern.dynamicproxy.IMovieStar;
import net.designpattern.dynamicproxy.ISingerStar;
import net.designpattern.dynamicproxy.ProxyHandler;
import net.designpattern.dynamicproxy.Star;
