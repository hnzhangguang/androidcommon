...
public class DialogActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showList() {
        ...
        builder = new AlertDialog.Builder(this).setIcon(R.mipmap.ic_launcher)
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(DialogActivity.this, "你点击的内容为： " + items[i], Toast.LENGTH_LONG).show();
        ...
        builder = new AlertDialog.Builder(this).setIcon(R.mipmap.ic_launcher)
                ...
                .setMultiChoiceItems(items, isSelect, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(DialogActivity.this, "你选择了" + str, Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showSingSelect() {
        ...
        builder = new AlertDialog.Builder(this).setIcon(R.mipmap.ic_launcher).setTitle("单选列表")
                .setSingleChoiceItems(items, 0, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (choice != -1) {
                            Toast.makeText(DialogActivity.this, "你选择了" + items[choice],
    ...
    private void showInput() {
        ...
        builder = new AlertDialog.Builder(this).setTitle("输入框dialog").setView(editText)
                .setPositiveButton("读取输入框内容", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(DialogActivity.this, "输入内容为：" + editText.getText().toString()
                                , Toast.LENGTH_LONG).show();
                    }
                });
        builder.create().show();
    ...
    private void showMyStyle() {
        @SuppressLint("InflateParams") View view =
                LayoutInflater.from(this).inflate(R.layout.layout_test, null);
                        ...
                        .setPositiveButton("登录", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(DialogActivity.this,
                                        "账号： " + etUsername.getText().toString() + "  密码： " + etPassword.getText().toString()
                                        , Toast.LENGTH_LONG).show();
                            }
                        });
