package com.yy.app.animator.etc;
            ...
            public void onClick(View v) {
                ...
                switch (animid) {
                    ...
                    case R.id.scale:
                        ...
                        scaleAnimation = new ScaleAnimation(fromxScale, toxScale, fromyScale, toyScale
                                , pivotx, pivoty);
                        setdefault(scaleAnimation);
                        animation = scaleAnimation;
                        break;
                    case R.id.translate:
                        translateAnimation = new TranslateAnimation(fromxDelta, toxDelta, fromyDelta,
                                toyDelta);
