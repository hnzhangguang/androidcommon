package datastruct.lzz.nonlinear.tree;


import datastruct.lzz.linear.queue.link.LinkQueue;
import datastruct.lzz.nonlinear.node.BiTreeNode;
...
public class BiTree {
    ...
    public BiTree(String preOrder, String inOrder, int preIndex, int inIndex, int count) {
        if (count > 0) {
            ...
            root.rchild = new BiTree(preOrder, inOrder, preIndex + i + 1, inIndex + i + 1, count
                    - i - 1).root;
        }
    }
