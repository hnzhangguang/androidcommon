...
public class QikuUtils {
    ...
    public static void applyPermission(Context context) {
        ...
        if (isIntentAvailable(intent, context)) {
            ...
            intent.setClassName("com.qihoo360.mobilesafe", "com.qihoo360.mobilesafe.ui.index" +
                    ".AppEnterActivity");
            if (isIntentAvailable(intent, context)) {
                context.startActivity(intent);
            } else {
                Log.e(TAG, "can't open permission page with particular name, please use " +
                        "\"adb shell dumpsys activity\" command and tell me the name of the float " +
                        "window permission page");
            }
        }
    }
