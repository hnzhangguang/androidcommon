...
public class SceneLocationActivity extends Activity {
    ...
    private static final DemoInfo[] DEMOS = {
            new DemoInfo(R.string.demo_title_signin, R.string.demo_desc_signin,
                    SignInSceneActivity.class),
            new DemoInfo(R.string.demo_title_sport, R.string.demo_desc_sport, SportSceneActivity.class),
            new DemoInfo(R.string.demo_title_transport, R.string.demo_desc_transport,
                    TransportSceneActivity.class),
    };
}
