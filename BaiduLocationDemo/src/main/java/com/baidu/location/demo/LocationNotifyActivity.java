    ...
    private Handler notifyHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                int radius = Integer.parseInt(mRadius.getText().toString());
                // 设置位置提醒的点的相关参数，
                mNotifyLister.SetNotifyLocation(mlatitude, mlongitude, radius,
                        mLocationClient.getLocOption().getCoorType());//4
                // 个参数代表要位置提醒的点的坐标，具体含义依次为：纬度，经度，距离范围，坐标系类型(gcj02,gps,bd09,bd09ll)
